...
def detect_encoding(file_path):
    """
    Accepts: file_path
    Outputs: the encoding of the file
    """
    try:
...
def encode_image(image_path):
    """
    Accepts: image_path
    Outputs: base64 encoded string for the image
    """
...
def open_file(file_path):
    """
    Accepts: file_path
    Outputs: Returns the dataframe of the file
    """
...
def summarize(dataset):
    """
    Accepts: dataset (A pandas dataframe)
    Outputs: summary of the dataset
    """
    # Describing dataset
